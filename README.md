...
> ℹ️ 本版本内容仅含 ①可公开核验来源 ②作者原创方法论，已剥离任何非公开内部资料的实质内容，并经两轮对抗式合规审计（0 blocker）。
...
本仓库内容只有两类——①**可公开核验的来源**（已公布的法律、行政法规、规章、国家标准、国家级规划/办法，及交易所**官网公开发布**的交易规则、国家数据局示范文本），②**作者原创的通用方法论**（审查维度、矛盾识别、时间线审计、风险矩阵等）。
